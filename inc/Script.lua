...
local function iBoss(msg,MsgText)
    ...
    if UserID == 1242023325 or UserID == 552311977 then return sendMsg(msg.chat_id_,msg.id_,"📛*¦* لآ يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
    ...
    local inline = {{{text="قنآهہ‏‏ آلسـورس : الـزعـيـم 🍃",url="/t.me/GPS_RONZABOT"}}}
    send_key(msg.sender_user_id_,'  [قناة السورس : الـزعـيـم](/t.me/GPS_RONZABOT)',nil,inline,msg.id_)
    return false
    end
    ...
    ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
    📮┇ [Source Programmer](https://t.me/MUHKJ)
    
    ♻️┇ [Twasl Bot Programmer](https://t.me/Taw_Ronzabot)
