...
download_file('https://raw.githubusercontent.com/abuwalidmj20/RONZA/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/abuwalidmj20/RONZA/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/abuwalidmj20/RONZA/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/abuwalidmj20/RONZA/master/inc/functions.lua','./inc/functions.lua')
...
var = 'هذا البوت 🙄☝🏿' 
elseif UserID == 1242023325 or UserID == 552311977  then 
var = 'مطور السورس'
...
message = message ..i.. '-l ['..info.username..'](/t.me/GPS_RONZABOT) \n'
end
...
message = message ..k.. '-l ['..info.username..'](/t.me/GPS_RONZABOT) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-l ['..info.username..'](/t.me/GPS_RONZABOT) l » (`' ..v.. '`) \n'
end
end
end
...
if UserID == 1242023325 or UserID == 552311977 then return sendMsg(ChatID,MsgID,"📛*¦* لآ يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
